...
CREATE TYPE "public"."project_status" AS ENUM('running', 'terminated');--> statement-breakpoint
CREATE TYPE "public"."ec2_status" AS ENUM('running', 'terminated');--> statement-breakpoint
CREATE TYPE "public"."account_providers" AS ENUM('google');--> statement-breakpoint
...
ALTER TABLE "instances" ADD CONSTRAINT "instances_instance_type_instance_types_id_fk" FOREIGN KEY ("instance_type") REFERENCES "public"."instance_types"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
