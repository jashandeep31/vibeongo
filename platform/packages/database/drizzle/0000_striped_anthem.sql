...
CREATE TYPE "public"."project_session_task_agents" AS ENUM('build', 'plan', 'reviewer', 'fixer');--> statement-breakpoint
...
CREATE TABLE "github_repos" (
	...
	CONSTRAINT "github_repos_user_id_full_name_unique" UNIQUE("user_id","full_name")
);
--> statement-breakpoint
