...
export function ProjectSessionFilesPage({
  projectId,
  projectSessionId,
  sessionId,
}: {
  ...
  return (
    <div className="bg-background text-foreground flex h-svh min-h-0 w-full flex-col">
      ...
      <main className="grid min-h-0 flex-1 grid-cols-1 grid-rows-[minmax(12rem,0.8fr)_minmax(18rem,1.2fr)] md:grid-cols-[20rem_minmax(0,1fr)] md:grid-rows-1">
        <aside className="bg-muted/10 flex min-h-0 flex-col overflow-hidden border-b md:border-r md:border-b-0">
          <div className="flex h-10 shrink-0 items-center gap-0.5 overflow-x-auto border-b px-2">
            <button
              ...
              onClick={() =>
                openDirectory(getParentPath(directory?.path ?? "/"))
              }
            >
              {openingDirectoryPath ===
              getParentPath(directory?.path ?? "/") ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <Button
                        ...
                        variant="ghost"
                        size="icon-xs"
                        className="text-muted-foreground hover:text-destructive mr-1 opacity-0 group-hover:opacity-100 focus-visible:opacity-100"
